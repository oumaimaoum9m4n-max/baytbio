  ...
  return (
    <section className="py-[120px] px-20 bg-[#faf8f5] relative max-md:py-16 max-md:px-5">
      <div className="text-center mb-16">
        <Reveal>
          <p className="text-[0.72rem] tracking-[0.22em] uppercase text-terracotta font-normal mb-3.5 flex items-center justify-center gap-3.5 before:content-[''] before:w-8 before:h-px before:bg-terracotta before:shrink-0">
        ...
        <Reveal delay={100}>
          <h2 className="font-cormorant text-[clamp(2.4rem,3.5vw,3.8rem)] font-light leading-[1.1] text-brown">
            Ce que disent
            <br />
            <em className="italic text-terracotta">nos clients</em>
          </h2>
        </Reveal>
        <Reveal delay={200}>
