  ...
  return (
    <div className="bg-cream border border-olive rounded-[3px] overflow-hidden">
      ...
      <div className="px-7 py-5 flex flex-col gap-2.5">
        ...
        <button
          onClick={onWhatsApp}
          className="cursor-pointer w-full h-12 bg-[#25D366] text-white border-none font-sans text-[0.76rem] tracking-[0.1em] uppercase rounded-[3px] transition-all duration-300 flex items-center justify-center gap-[9px] hover:bg-[#1AB854] hover:-translate-y-px"
        >
