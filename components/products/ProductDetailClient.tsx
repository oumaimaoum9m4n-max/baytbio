...
export default function ProductDetailClient({
  ...
  return (
    <div className="min-h-screen bg-cream">
      <nav className="flex items-center gap-2.5 px-[72px] pt-[108px] font-sans text-[0.74rem] uppercase tracking-[0.1em] text-sand max-md:px-6 max-md:pt-[88px]">
        <Link
          href="/products"
            ...
            >
              <span
                className={`h-[7px] w-[7px] rounded-full ${
                  product.stock > 0 ? "animate-blink bg-[#5A9A40]" : "bg-red-500"
                }`}
              />
              {freshnessLabel}
            </span>
